...
export const Title = ({ title }: Props) => {
  return (
    <div
      ...
      className="group font-heading relative text-center uppercase text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-wide text-white-text2 mb-16 sm:mb-20"
    >
      {title}
