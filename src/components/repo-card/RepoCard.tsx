...
export const RepoCard = ({ name, url }: Props) => {
  return (
    <div
      ...
      className="bg-body-bg2 py-3 px-4 text-white-text flex-between gap-3 rounded-xl border-l-2 border-main hover:shadow hover:shadow-main transition-shadow duration-300"
    >
